...
public class MJController {
    ...
    public void envoieIndice() {
        try {
            Media hit = new Media(getClass().getClassLoader().getResource("main/java/fr/unice/polytech/pel/polyescape/controller/notification.wav").toString());
    ...
    public void display() throws InterruptedException {
        ...
        if (this.hour==0 && this.minute==0){
            finDuJeu=true;
            Media hit = new Media(getClass().getClassLoader().getResource("main/java/fr/unice/polytech/pel/polyescape/controller/sonnerie.wav").toString());
            MediaPlayer mediaPlayer = new MediaPlayer(hit);
            mediaPlayer.play();
        }
        if (this.hour==0 && this.minute==1){//A MODIF
            ...
            Media hit = new Media(getClass().getClassLoader().getResource("main/java/fr/unice/polytech/pel/polyescape/controller/1min.mp3").toString());
            MediaPlayer mediaPlayer = new MediaPlayer(hit);
            mediaPlayer.play();
        }
